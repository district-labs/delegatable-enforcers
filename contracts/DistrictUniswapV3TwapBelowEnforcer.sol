...
contract DistrictUniswapV3TwapBelowEnforcer is CaveatEnforcer {
  ...
  function enforceCaveat(
    ...
    if (tickSign == 0) {
      ...
      revert("DistrictUniswapV3TwapBelowEnforcer:tickSign MUST be 0 (negative), or 1 (positive)");
    }
    ...
    if (tickThreshold < uniswapTwapTick) {
      ...
      revert("DistrictUniswapV3TwapBelowEnforcer:tickThreshold >= uniswapTwapTick");
    }
  }
